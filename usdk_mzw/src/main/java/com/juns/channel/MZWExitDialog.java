 ...
 * Author: ranger
 */
public class MZWExitDialog extends BaseDialog<MZWExitDialog> {

    private Button continueBtn, exitBtn;
    private MZWExitDialog.ExitCallback exitCallback;

    private MZWExitDialog(Activity act, MZWExitDialog.ExitCallback callback) {
        super(act, false);
        this.exitCallback = callback;
    }

    public static void showExit(Activity act, MZWExitDialog.ExitCallback exitCallback) {
        MZWExitDialog tipsDialog = new MZWExitDialog(act, exitCallback);
