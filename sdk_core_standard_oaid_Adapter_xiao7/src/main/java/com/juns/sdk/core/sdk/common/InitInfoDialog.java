...
public class InitInfoDialog extends BaseDialog<InitInfoDialog> {
    ...
    private static String user = "https://junshanggame.com/uagree/user_xiaomi.html";
    private static String  privacy= "https://junshanggame.com/uagree/privacy_xiaomi.html";
    ...
    public static void setPrivacy(String privacy) {
        InitInfoDialog.privacy = privacy;
    }
...
//                "如您同意本游戏的用户协议及隐私政策，请您点击“同意”开始使用我们的产品和服务，我们将尽全力保护您的个人信息安全。");
    ...
    private class TextViewSpan1 extends ClickableSpan {
        ...
        public void onClick(View widget) {
            new InitAgreementDialog((Activity) mContext,"用户协议",user)
    ...
    private class TextViewSpan2 extends ClickableSpan {
        ...
        @Override
        public void onClick(View widget) {
            new InitAgreementDialog((Activity) mContext,"隐私政策",privacy)
                    .showAnim(new BounceBottomEnter()).dismissAnim(new ZoomOutExit()).dimEnabled(true).show();
            //点击事件
