...
public class OPlatformUtils {
    ...
    public static void loginToServer(String token, String data,OLoginCallBack callBack) {
        loginToServer(token, null, null, data,callBack);
    }
    ...
    public static void loginToServer(String token, String uid, String name, String data , final OLoginCallBack callBack) {
        MVerifyParam mVerifyParam = new MVerifyParam(token, uid, name, data);
        x.http().post(mVerifyParam, new Callback.CommonCallback<JunSResponse>() {
            @Override
            public void onSuccess(JunSResponse junSResponse) {
                dealReqSuccess(junSResponse);
                callBack.onFinish(junSResponse.toString());
            }
