 ...
 * Author: ranger
 */
public class HuYaExitDialog extends BaseDialog<HuYaExitDialog> {

    private Button continueBtn, exitBtn;
    private HuYaExitDialog.ExitCallback exitCallback;

    private HuYaExitDialog(Activity act, HuYaExitDialog.ExitCallback callback) {
        super(act, false);
        this.exitCallback = callback;
    }

    public static void showExit(Activity act, HuYaExitDialog.ExitCallback exitCallback) {
        HuYaExitDialog tipsDialog = new HuYaExitDialog(act, exitCallback);
