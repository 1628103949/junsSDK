 ...
 * Author: ranger
 */
public class QingLanExitDialog extends BaseDialog<QingLanExitDialog> {

    private Button continueBtn, exitBtn;
    private QingLanExitDialog.ExitCallback exitCallback;

    private QingLanExitDialog(Activity act, QingLanExitDialog.ExitCallback callback) {
        super(act, false);
        this.exitCallback = callback;
    }

    public static void showExit(Activity act, QingLanExitDialog.ExitCallback exitCallback) {
        QingLanExitDialog tipsDialog = new QingLanExitDialog(act, exitCallback);
    ...
    public void setUiBeforeShow() {
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                QingLanExitDialog.this.dismiss();
