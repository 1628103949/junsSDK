 ...
 * Author: ranger
 */
public class GuaMExitDialog extends BaseDialog<GuaMExitDialog> {

    private Button continueBtn, exitBtn;
    private GuaMExitDialog.ExitCallback exitCallback;

    private GuaMExitDialog(Activity act, GuaMExitDialog.ExitCallback callback) {
        super(act, false);
        this.exitCallback = callback;
    }

    public static void showExit(Activity act, GuaMExitDialog.ExitCallback exitCallback) {
        GuaMExitDialog tipsDialog = new GuaMExitDialog(act, exitCallback);
