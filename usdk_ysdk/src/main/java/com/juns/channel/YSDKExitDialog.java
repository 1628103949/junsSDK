 ...
 * Author: ranger
 */
public class YSDKExitDialog extends BaseDialog<YSDKExitDialog> {

    private Button continueBtn, exitBtn;
    private YSDKExitDialog.ExitCallback exitCallback;

    private YSDKExitDialog(Activity act, YSDKExitDialog.ExitCallback callback) {
        super(act, false);
        this.exitCallback = callback;
    }

    public static void showExit(Activity act, YSDKExitDialog.ExitCallback exitCallback) {
        YSDKExitDialog tipsDialog = new YSDKExitDialog(act, exitCallback);
