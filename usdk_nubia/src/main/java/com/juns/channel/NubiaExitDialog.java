 ...
 * Author: ranger
 */
public class NubiaExitDialog extends BaseDialog<NubiaExitDialog> {

    private Button continueBtn, exitBtn;
    private NubiaExitDialog.ExitCallback exitCallback;

    private NubiaExitDialog(Activity act, NubiaExitDialog.ExitCallback callback) {
        super(act, false);
        this.exitCallback = callback;
    }

    public static void showExit(Activity act, NubiaExitDialog.ExitCallback exitCallback) {
        NubiaExitDialog tipsDialog = new NubiaExitDialog(act, exitCallback);
