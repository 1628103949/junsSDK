 ...
 * Author: ranger
 */
public class MMYExitDialog extends BaseDialog<MMYExitDialog> {

    private Button continueBtn, exitBtn;
    private MMYExitDialog.ExitCallback exitCallback;

    private MMYExitDialog(Activity act, MMYExitDialog.ExitCallback callback) {
        super(act, false);
        this.exitCallback = callback;
    }

    public static void showExit(Activity act, MMYExitDialog.ExitCallback exitCallback) {
        MMYExitDialog tipsDialog = new MMYExitDialog(act, exitCallback);
