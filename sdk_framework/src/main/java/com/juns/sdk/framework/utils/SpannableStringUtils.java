...
public final class SpannableStringUtils {
    ...
    public static class Builder {
         ...
         * @return {@link Builder}
         */
        public Builder setQuoteColor(int color, int stripeWidth, int quoteGapWidth) {
            this.quoteColor = color;
         ...
         * @return {@link Builder}
         */
        public Builder setBullet(int gapWidth) {
            this.bulletColor = 0;
            this.bulletRadius = 3;
         ...
         * @return {@link Builder}
         */
        public Builder setBullet(int color, int radius, int gapWidth) {
         ...
         * @return {@link Builder}
         */
        public Builder setAlign(Alignment alignment) {
         ...
         * @return {@link Builder}
         */
        public Builder setBitmap(Bitmap bitmap, @Align int align) {
            this.bitmap = bitmap;
            this.align = align;
            this.text = " " + this.text;
            imageIsBitmap = true;
         ...
         * @return {@link Builder}
         */
        public Builder setDrawable(Drawable drawable, @Align int align) {
         ...
         * @return {@link Builder}
         */
        public Builder setUri(Uri uri, @Align int align) {
            this.uri = uri;
            this.align = align;
            this.text = " " + this.text;
            imageIsUri = true;
         ...
         * @return {@link Builder}
         */
        public Builder setResourceId(int resourceId, @Align int align) {
         ...
         * @return {@link Builder}
         */
        public Builder appendLine(CharSequence text) {
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        CustomImageSpan(Context context, int resourceId, int verticalAlignment) {
            super(verticalAlignment);
            mContext = context;
