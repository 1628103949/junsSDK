...
import com.juns.sdk.framework.xutils.common.util.KeyValue;
import com.juns.sdk.framework.xutils.common.util.LogUtil;
import com.juns.sdk.framework.xutils.http.body.BodyItemWrapper;
import com.juns.sdk.framework.xutils.http.body.FileBody;
import com.juns.sdk.framework.xutils.http.body.InputStreamBody;
import com.juns.sdk.framework.xutils.http.body.MultipartBody;
import com.juns.sdk.framework.xutils.http.body.RequestBody;
import com.juns.sdk.framework.xutils.http.body.StringBody;
import com.juns.sdk.framework.xutils.http.body.UrlEncodedParamsBody;
...
//            sb.append("<");
            if (!TextUtils.isEmpty(bodyContent)) {
                sb.append(Uri.encode(bodyContent, "UTF-8"));
            } else {
                if (!bodyParams.isEmpty()) {
                    for (KeyValue kv : bodyParams) {
                        sb.append(Uri.encode(kv.key, "UTF-8")).append("=").append(Uri.encode(kv.value.toString(), "UTF-8")).append("&");
                    }
                    sb.deleteCharAt(sb.length() - 1);
                }
            }
