package com.juns.sdk.framework.utils;
...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(String packageName, String className) {
        ...
        return !(com.juns.sdk.framework.utils.Utils.getContext().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(com.juns.sdk.framework.utils.Utils.getContext().getPackageManager()) == null ||
                com.juns.sdk.framework.utils.Utils.getContext().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(String pkg, String cls) {
        startActivity(com.juns.sdk.framework.utils.Utils.getContext(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(Bundle extras, String pkg, String cls) {
        startActivity(com.juns.sdk.framework.utils.Utils.getContext(), extras, pkg, cls, extras);
    }
    ...
    public static void startActivity(String pkg, String cls, Bundle options) {
        startActivity(com.juns.sdk.framework.utils.Utils.getContext(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(Bundle extras, String pkg, String cls, Bundle options) {
        startActivity(com.juns.sdk.framework.utils.Utils.getContext(), extras, pkg, cls, options);
    }
    ...
    public static String getLauncherActivity(String packageName) {
        ...
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        PackageManager pm = com.juns.sdk.framework.utils.Utils.getContext().getPackageManager();
