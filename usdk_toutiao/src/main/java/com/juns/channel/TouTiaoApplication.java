...
public class TouTiaoApplication extends RocketApplication {
    ...
    public void onCreate() {
        super.onCreate();
        TNFramework.globalReady(TouTiaoApplication.this, getDebugConfig());
        sdkApp.proxyOnCreate(TouTiaoApplication.this);
