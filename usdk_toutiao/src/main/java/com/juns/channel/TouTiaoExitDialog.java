 ...
 * Author: ranger
 */
public class TouTiaoExitDialog extends BaseDialog<TouTiaoExitDialog> {

    private Button continueBtn, exitBtn;
    private TouTiaoExitDialog.ExitCallback exitCallback;

    private TouTiaoExitDialog(Activity act, TouTiaoExitDialog.ExitCallback callback) {
        super(act, false);
        this.exitCallback = callback;
    }

    public static void showExit(Activity act, TouTiaoExitDialog.ExitCallback exitCallback) {
        TouTiaoExitDialog tipsDialog = new TouTiaoExitDialog(act, exitCallback);
    ...
    public void setUiBeforeShow() {
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TouTiaoExitDialog.this.dismiss();
